	...
	<form action="/" method="post" accept-charset="utf-8">
		...
		<div class="row">
			<div class="form-group col-xs-12 @if ($errors->has('pasteTitle')) has-error @endif">
				...
				<input type="text" class="form-control" name="pasteTitle" id="pasteTitle" placeholder="Title (optional)" maxlength="150" value="{{ old('pasteTitle') }}@if (isset($clonedTitle))Clone of : {{ $clonedTitle }}@endif">
